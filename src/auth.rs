...
pub const ALPACA_SANDBOX_TOKEN_URL: &str = "https://authx.sandbox.alpaca.markets/v1/oauth2/token";
...
const TOKEN_MAX_LIFETIME: Duration = Duration::from_hours(1);
...
mod tests {
    ...
    async fn refresh_failure_rides_the_still_valid_cached_token() {
        ...
        *auth.cached.lock().unwrap() = Some(CachedToken {
            ...
            hard_expiry: Instant::now() + Duration::from_mins(1),
        });
